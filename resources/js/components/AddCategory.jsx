...
function AddCategory({ message, setMessage, editFormData, editing, onCancelEdit, getCategories }) {
    ...
    const handleSubmit = async (e) => {
        ...
        if (editing) {
            // Update category
            const res = await CategoryApis.update(formData);
            if (res.success) {
                    ...
                    <div className='flex items-center justify-center min-h-screen'>
                        ...
                        <div className='relative bg-white p-8 rounded-lg left-12'>
                            ...
                            <div className='flex justify-between mb-8 border-b-[1px] border-[#e5e5e5]'>
                                <h2 className='text-2xl font-black'>{editing ? 'Edit Category' : 'Create Category'}</h2>
                                <button
                                    onClick={toggleModal}
                                ...
                                <div>
                                    <div className='mb-4'>
                                        ...
                                        <textarea
                                            ...
                                            className='mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full drop-shadow-md p-4  border-gray-300 rounded-md border h-14'
